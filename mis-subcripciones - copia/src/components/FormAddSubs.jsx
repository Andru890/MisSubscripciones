        ...
        <div>
            <div className="add-subscription">
                ...
                <form onSubmit={handleSubs}>
                    ...
                    <p>Cantidad</p>
                    <input type="number" placeholder="50$" onChange={e => setPrice(e.target.value)} value={price} />
                    {
            ...
            </div>
            {
             ...
             {
                errorMoney ? <p className="error">Sin saldo sufuciente </p> : null
            }
        </div>
    )
}
